...
interface MagicButtonProps {
  ...
  position: "left" | "right"; // Restrict to valid values
  handleClick?: () => void; // Make it optional
  otherClasses?: string; // Add missing type
}
  ...
  return (
    <div>
      <button
        ...
        className={`relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none ${otherClasses}`} // Apply custom classes
      >
